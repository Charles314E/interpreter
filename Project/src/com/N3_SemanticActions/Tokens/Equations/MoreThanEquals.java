...
public class MoreThanEquals extends Equation {
    public MoreThanEquals() {}
    public MoreThanEquals(Expression e1, Expression e2) {
        this.e1 = e1;
        this.e2 = e2;
    }
    ...
    public MoreThanEquals construct(ArrayList<Token> arguments) {
        return (assignParameters(arguments) ? this : null);
    }

    public String toString() {
        return "More Than Equals";
    }
