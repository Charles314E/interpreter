...
public class NoLookaheadToReduceAction<T extends Item> extends ReduceAction<T> {
    List<String> lookahead;
    public NoLookaheadToReduceAction(ParserActionGrid<T> grid, Grammar rule, String[] lookahead) {
        super(grid, rule);
    ...
    public String toString() {
        ...
        return "r" + rule.getParser().getRules().indexOf(rule) + (lookahead != null ? "ifnot" + stringMethods.encapsulatedTuple("", "", "or", lk) : "");
    }

    public boolean equals(NoLookaheadToReduceAction o) {
